...
module.exports = {
  ...
  fee: {
    depositPct: parseFloat(process.env.DEPOSIT_FEE_PCT || '0.01'),  // cut 1: 1% on every deposit
    tipPct:     parseFloat(process.env.TIP_FEE_PCT     || '0.03'),  // cut 2: 3% on every tip send
